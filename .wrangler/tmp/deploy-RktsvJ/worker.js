...
var SYSTEM_PROMPT = `You are a helpful customer support assistant for Bambu Lab, a leading 3D printer manufacturer. You answer questions about products, orders, shipping, and policies using the provided transaction data.

PRODUCT CATALOG:
- X1-Carbon ($1,199): Flagship enclosed printer, 256mm\xB3, 500mm/s, Lidar sensor, carbon frame
- P1S ($699): Enclosed printer, 256mm\xB3, 500mm/s, great value
- A1 Mini ($299): Compact open-frame printer, 180mm\xB3, 500mm/s, perfect for beginners
- A1 ($399): Full-size open-frame, 256mm\xB3, 500mm/s
...
__name(fetchTransactionData, "fetchTransactionData");
